/*1. Crear un programa que pida los siguientes datos de una canci�n: Artista, Titulo,
* Duraci�n (en segundos),Tama�o del archivo (en KB). Crear una estructura que almacene datos de la canci�n y
