...
Luego crear un men� que permita las opciones:
...
Generar un vector de estructuras del tipo empleado de tama�o 3.
Para cada uno de los �tems del men� crear una funci�n.
...
void add_employee(employee *em) {
    ...
    for (int ii = 0; ii < 3; ii++) {
        ...
        cin >> em[ii].salary;
        cout << "Ingrese los a�os de antig�edad del empleado" << endl;
        cin >> em[ii].antiquity;
        cout << endl;
    }
}
...
void show_employee_list(employee *em) {
    ...
    for (int ii = 0; ii < 3; ii++) {
        ...
        cout << "Anios de antiguedad: " << em[ii].antiquity << endl;
        cout << endl;
    }
}
...
void search_employee(employee *em) {
    ...
    for (int ii = 0; ii < 3; ii++) {
        if (em[ii].legacy == l) {
            ...
            cout << "Puesto: " << em[ii].job << endl;
            cout << "Salario: " << em[ii].salary << endl;
            cout << "A�os de antig�edad: " << em[ii].antiquity << endl;
        }
    }
    cout << endl;
}
